...
password, address, birth_date, civil_status, education, id_card, locality_id, number_card, personal_email, phone, code_province, sex, workplace, role, photo,validated,alert_channel)
...
'0723452223', 'B', 'MAN', 'Profesor la Facultatea de drept', 'ROLE_ADMIN',null,true,'EMAIL');
COMMIT;		
...
'0723452223', 'B', 'MAN', 'Primar Râmnicu Vâlcea', 'ROLE_ADMIN',null,true,'EMAIL');
COMMIT;	
...
'0723452223', 'B', 'MAN', 'Doctor inginer în specializarea Mecanică Tehnică', 'ROLE_ADMIN', null,true,'EMAIL');
COMMIT;	
