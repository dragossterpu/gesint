...
public class AcasaBean implements Serializable {
        ...
        private void createHorizontalBarModel() {
                ...
                boys.set(Utilitati.luna(getData(filtruStatistica.getDataUltimOptLuni())),
                ...
                boys.set(Utilitati.luna(getData(filtruStatistica.getDataUltimNouaLuni())),
                ...
                boys.set(Utilitati.luna(getData(filtruStatistica.getDataUltimZeceLuni())),
                                statistica.getTotalUltimUnspeLuni());
                if (statistica.getTotalUltimUnspeLuni() > numarMaxim) {
                        numarMaxim = statistica.getTotalUltimAn();
                }
                boys.set(Utilitati.luna(getData(filtruStatistica.getDataUltimUnspeLuni())),
