...
public class EMailImpl implements EMail {
        ...
        private void trimitereMail(final String destinatar, final String titlu, final String body,
                        final List<Documentul> fisiereIncarcate, final String sablon,
                        final Map<String, String> paramSablon) throws IOException, PebbleException {
                try {
                        ...
                        message.addRecipients(Message.RecipientType.TO,
                                        new InternetAddress[] { new InternetAddress(destinatar) });
                        ...
                        t.connect((String) props.get("dragossterpu@gmail.com"), "482217969Mmadrid");
        ...
        public Date send(final Corespondenta corespondenta, final List<Utilizator> utilizatoriSelectionati,
                        final List<Documentul> documenteIncarcate, final String sablon,
                        final Map<String, String> paramSablon) throws PebbleException {
         ...
         */
        @Override
        public void trimitereEmail(final String paramDestinatar, final String paramtitlu,
                        final String sablonEmailParola, final Map<String, String> paramSablon) {
                try {
                        trimitereMail(paramDestinatar, "Restabilire utilizator sau parola", null, null,
                                        sablonEmailParola, paramSablon);
                }
