...
public class LazyDataUtilizatori extends LazyDataModel<Utilizator> implements Serializable {
	 ...
	 */
	public LazyDataUtilizatori(final UtilizatorService serviciu) {
	 ...
	 * @param sortField coloana prin care vor fi sortate rezultatele. Corespunde proprietății „sortBy” a coloanei din
	 * pagina
	...
	public List<Utilizator> load(final int first, final int pageSize, final String sortField, final SortOrder sortOrder,
		...
		if (filtruUtilizator == null) {
			...
			listaUtilizatori = utilizatorService.cautareUtilizatorCriteria(first, pageSize, sortField, sortOrder,
					filtruUtilizator);
