...
import ro.stad.online.gesint.lazydata.LazyDataUtilizatoriLocal;
...
public class UtilizatorBean implements Serializable {
         ...
         * Obiectul de cautare al utilizatorilor.
         */
        private FiltruUtilizator filtruUtilizatorLocal;
         ...
         * LazyModel pentru paginarea de pe serverul de date de căutare a utilizatorilor.
         */
        private LazyDataUtilizatoriLocal modelLocal;
        ...
        public void activareUtilizator(final Utilizator usu) {
                try {
                        ...
                        final String descriere = Constante.UTILIZATORUL.concat(usu.getNumeComplet())
                                        .concat(" a fost reactivat cu succes de: ")
                                        .concat(utilitati.getUtilizatorLogat().getUsername());
                        this.regActividadService.inregistrareRegistruActivitate(descriere,
                                        RegistruEnum.ACTIVARE.getName(), SectiuniEnum.USERS.getName(),
         ...
         */
        public List<Localitate> actualizareLocalitati(final List<String> prov) {
                this.localitati = new ArrayList<>();
                this.listaJudete = this.judetService.findById(prov);
                this.filtruUtilizator.setListaJudeteSelectate(listaJudete);
                if (!this.listaJudete.isEmpty()) {
                        try {
                                this.localitati = this.localitateService.findByJudete(this.listaJudete);
        ...
        public void cautareUtilizator() {
                this.filtruUtilizator.setListaFunctii(new ArrayList<>());
                if ("Administrator".equals(this.user.getRole().getDescription())) {
                        this.model.setFiltruUtilizator(this.filtruUtilizator);
                }
                else {
                        // Daca nu este administrator poate cauta numai persoanele din judetul lui
                        this.filtruUtilizator
                                        .setIdJudet(this.utilitati.getUtilizatorLogat().getCodJudet().getIndicator());
                        this.model.setFiltruUtilizator(this.filtruUtilizator);
                }
        ...
        public List<Utilizator> cautareUtilizatoriCentral() {
                ...
                final String descriere = "Utillizatorul: ".concat(this.user.getNumeComplet())
                ...
                this.regActividadService.inregistrareRegistruActivitate(descriere, RegistruEnum.CAUTARE.getName(),
                                SectiuniEnum.USERS.getName(), utilitati.getUtilizatorLogat());
        ...
        public void cautareUtilizatorLocal() {
                ...
                if (this.filtruUtilizatorLocal.getIdFunctia() == null) {
                        final List<Functie> lista = incarcamToateFunctileLocale();
                        this.filtruUtilizatorLocal.setListaFunctii(lista);
                }
                try {
                        this.modelLocal.setFiltruUtilizatorLocal(this.filtruUtilizatorLocal);
                        this.modelLocal.load(0, NumarMagic.NUMBERFIFTEEN, Constante.DATECREATE, SortOrder.DESCENDING,
                                        null);
                        this.listUsersLocal = modelLocal.getDataSource();
                        ...
                        String mesajModificare = mesajCautareUtilizator(filtruUtilizatorLocal);
                        // Daca a fost o cautare cu parametrii o inregistram pentru auditorie
                        if (!Constante.SPATIU.equals(mesajModificare)) {
        ...
        public void curatareCautare() {
                ...
                this.filtruUtilizatorLocal = new FiltruUtilizator();
                this.filtruEchipa = new FiltruEchipa();
                this.listUsersLocal = new ArrayList<>();
                this.rowCountLocal = NumarMagic.NUMBERZERO;
                this.model = new LazyDataUtilizatori(this.utilizatorService);
                this.model.setRowCount(NumarMagic.NUMBERZERO);
                this.modelLocal = new LazyDataUtilizatoriLocal(this.utilizatorService);
                this.modelLocal.setRowCount(NumarMagic.NUMBERZERO);
        }
                ...
                if (this.functieIdUser != usu.getTeam().getId()) {
                        ...
                        try {
                                ...
                                final String descriere = "Utillizatorului: ".concat(usu.getNumeComplet())
                                                ...
                                                .concat(utilitati.getUtilizatorLogat().getUsername());
                                this.regActividadService.inregistrareRegistruActivitate(descriere,
                                                RegistruEnum.ELIMINARE.getName(), SectiuniEnum.USERS.getName(),
                                                utilitati.getUtilizatorLogat());
                                log.info(descriere);
                        }
                        catch (final DataAccessException e) {
                        ...
                        if (vecheFunctie.getId() != NumarMagic.NUMBERTHIRTYL
                                ...
                                usu.setRank(Long.valueOf(this.listUsersCentral.size() + NumarMagic.NUMBERONELONG));
                        }
                        if (vecheFunctie.getId() != NumarMagic.NUMBERTHIRTYL
                                        && nouaFunctie.getOrganizatie().equals(Constante.CONDUCERELOCALA)) {
                                this.listUsersLocal.add(usu);
                                usu.setRank(Long.valueOf(this.listUsersLocal.size() + NumarMagic.NUMBERONELONG));
                        }
                }
        }
        ...
        public void eliminareUtilizator(final Utilizator usu) {
                try {
                        ...
                        log.info("eliminareUtilizator: userul:".concat(utilizator.getNumeComplet())
                                        ...
                                        .concat(utilitati.getUtilizatorLogat().getUsername()));
                        final String descriere = Constante.UTILIZATORUL.concat(usu.getNumeComplet())
                                        .concat(" a fost eliminat cu succes  de: ")
                                        .concat(utilitati.getUtilizatorLogat().getUsername());
                        this.regActividadService.inregistrareRegistruActivitate(descriere,
                                        RegistruEnum.ELIMINARE.getName(), SectiuniEnum.USERS.getName(),
                                        utilitati.getUtilizatorLogat());
        ...
        /**
         * Metoda extract care valideaza o functie a unui utilizator
         * @param usu
         * @param vecheFunctie
         */
        private void extractFunctieMembru(final Utilizator usu, final Functie vecheFunctie) {
                if (this.functieIdUser != NumarMagic.NUMBERTHIRTYL
                        ...
                        this.modelLocal.setDataSource(this.listUsersLocal);
                        reordonareMembru();
                        usu.setRank(null);
                }
        }
        ...
        /**
         * Metoda extract care recupereaza prima localitate
         * @param local
         */
        ...
        /**
         * Metoda extract care valideaza un utilizator
        ...
        private void extractUserValida(final String mesajModificare, final String valida) {
                if (validar(valida)) {
                        ...
                        this.regActividadService.inregistrareRegistruActivitate(descriere,
                                        RegistruEnum.MODIFICARE.getName(), SectiuniEnum.USERS.getName(),
                                        utilitati.getUtilizatorLogat());
                }
                else {
        ...
        /**
         * Metoda extract care valideaza un judet
         * @param jude
         * @return
         */
        ...
        /**
         * Metoda extract care valideaza o localitate
         */
        ...
        public String getFormInregistrareUtilizator() {
                ...
                return "/users/inregistreazaNouUtilizator.xhtml?faces-redirect=true";
        }
        ...
        public void init() {
                ...
                for (int i = NumarMagic.NUMBERZERO; i <= NUMARTCOLOANELISTAUTILIZATORI; i++) {
                ...
                try {
                        ...
                        if (validar(valida)) {
                                ...
                                this.regActividadService.inregistrareRegistruActivitate(descriere,
                                                ...
                                                this.utilitati.getUtilizatorLogat());
                        }
                        else {
                                FacesUtilities.setMesajConfirmareDialog(FacesMessage.SEVERITY_ERROR,
        ...
        private String mesajModificareUtilizator(final Utilizator usu) {
                ...
                if (!this.utilizatorModificat.getDataNasterii().equals(usu.getDataNasterii())) {
                        ...
                        mesajModificare = mesajModificare.concat(
                ...
                if (!utilizatorModificat.getLocMunca().equals(usu.getLocMunca())) {
                        mesajModificare = mesajModificare.concat(" Loculul de muncă anterior : "
                ...
                if (!this.utilizatorModificat.getStatutCivil().equals(usu.getStatutCivil())
                        ...
                        mesajModificare = mesajModificare
                                        .concat(" Starea civilă anterioară : ".concat(this.utilizatorModificat
                ...
                if (!this.utilizatorModificat.getValidat().equals(usu.getValidat())) {
                        ...
                        mesajModificare = mesajModificare
                                        .concat(" Starea anterioară : ".concat(valida.concat(Constante.VIRGULA)));
                }
                if (!this.utilizatorModificat.getCodJudet().equals(usu.getCodJudet())
                                && this.utilizatorModificat.getCodJudet() != null) {
                        mesajModificare = mesajModificare.concat(" Județul/Organizația anterioară : ".concat(
                ...
                if (this.utilizatorModificat.getLocalitate() != null
                        ...
                        mesajModificare = mesajModificare.concat(" Localitatea/Sectorul anterior : "
        ...
        private void reordonareMembru() {
                ...
                try {
                        for (int i = NumarMagic.NUMBERZERO; i < this.listUsersLocal.size(); i++) {
        ...
        private void reordonareMembruCC() {
                Utilizator user = new Utilizator();
                try {
                        for (int i = NumarMagic.NUMBERZERO; i < this.listUsersCentral.size(); i++) {
                                user = this.listUsersCentral.get(i);
                                user.setRank(i + NumarMagic.NUMBERONELONG);
                                this.utilizatorService.save(user);
                                final RequestContext context = RequestContext.getCurrentInstance();
        ...
        public String restabilireParola() {
                try {
                        ...
                        this.utilizatorService.save(this.utilizator);
                        // this.correoService.trimitereEmail(this.usuario.getUsername(),
        ...
        public void schimbTipMembri(final TabChangeEvent event) {
                if (Constante.TABMEMBRI.equals(event.getTab().getId())) {
                        this.filtruUtilizator = new FiltruUtilizator();
                        this.filaActiva = Constante.TABMEMBRI;
                        curatareCautare();
                }
                else if (Constante.TABLOCAL.equals(event.getTab().getId())) {
                        this.filtruUtilizatorLocal = new FiltruUtilizator();
