...
(select count(*) from users where educatie= 'LICEU') AS totalcuLiceu,
(select count(*) from users where educatie= 'STUDIISUPERIOARE') AS totalStudiiSup,
(select count(*) from users where educatie= 'BAZIC') AS totalBazice,
...
(select count(*)  from users where data_nasterii between date '1994-02-10' and date '2019-02-12') as total25,
(select count(*)  from users where data_nasterii between date '1994-02-10' and date '2019-02-12' and sex= 'MAN') as totalBarbati25,
(select count(*)  from users where data_nasterii between date '1979-02-10' and date '1994-02-10') as total40,
(select count(*)  from users where data_nasterii between date '1979-02-10' and date '1994-02-10' and sex= 'MAN') as totalBarbati40,
(select count(*)  from users where data_nasterii between date '1959-02-10' and date '1979-02-10') as total60,
(select count(*)  from users where data_nasterii between date '1959-02-10' and date '1979-02-10' and sex= 'MAN') as totalBarbati60,
(select count(*)  from users where data_nasterii ::date <= '1959-02-10') as totalMayor60,
